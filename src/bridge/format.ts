...
const BRIDGE_ACTION_INSTRUCTIONS = [
  ...
  "Use a fenced codex-im-gateway-actions JSON block instead, for example:",
...
const LEGACY_BRIDGE_ACTION_INSTRUCTIONS = [
  BRIDGE_ACTION_INSTRUCTIONS.replaceAll("codex-im-gateway-actions", "codex-channel-bridge-actions"),
  BRIDGE_ACTION_INSTRUCTIONS.replaceAll("codex-im-gateway-actions", "codex-weixin-actions"),
  BRIDGE_ACTION_INSTRUCTIONS.replaceAll("codex-im-gateway-actions", "codex-weixin-server-actions")
];
